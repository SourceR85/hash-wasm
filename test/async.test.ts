...
test('Async cycle multiple algorithms', async (): Promise<void> => {
  ...
  for (let i = 0; i < 250 * 8; i += 11) {
    expect(res[i + 0]).toBe('333fcb4ee1aa7c115355ec66ceac917c8bfd815bf7587d325aec1864edd24e34d5abe2c6b1b5ee3face62fed78dbef802f2a85cb91d455a8f5249d330853cb3c');
    ...
    expect(res[i + 4]).toBe('ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb');
    expect(res[i + 5]).toBe('54a59b9f22b0b80880d8427e548b7c23abd873486e1f035dce9cd697e85175033caa88e6d57bc35efae0b5afd3145f31');
    expect(res[i + 6]).toBe('9e86ff69557ca95f405f081269685b38e3a819b309ee942f482b6a8b');
    expect(res[i + 7]).toBe('7cf87d912ee7088d30ec23f8e7100d9319bff090618b439d3fe91308');
