...
test('simple strings', async () => {
  ...
  expect(await crc32('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789')).toBe('1fc2e6d2');
  expect(await crc32('12345678901234567890123456789012345678901234567890123456789012345678901234567890')).toBe('7ca94a72');
});
